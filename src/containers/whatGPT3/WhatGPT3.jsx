...
function WhatGPT3() {
  return (
    <div className="anmol-port__about section__margin" id='wgpt3'>
      <div className="anmol-port__about-feature">
      ...
      <div className="anmol-port__about-heading">
        <h1 className="gradient__text">
          Eager to Collaborate and Contribute to Meaningful Projects
        </h1>
        <p>Explore The Library</p>
      </div>
      <div className="anmol-port__about-container">
        ...
        <Feature title={"Asspirations"} text={"Driven to create seamless web experiences, I am to contribute my skills to meaningful projects. Comitted to continuous learning, I strive to leave a lasting impact"}/>
      </div>
